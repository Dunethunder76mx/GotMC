...
public class ModelDragonstoneChainmailArmor extends ModelArmorBase {
  public static Map<EntityEquipmentSlot, ModelDragonstoneChainmailArmor> SINGLETONS = new HashMap<>();
  ...
  public ModelDragonstoneChainmailArmor(EntityEquipmentSlot slot) {
    super(slot);
  ...
  @Nullable
  public static ModelDragonstoneChainmailArmor getInstance(EntityEquipmentSlot slot) {
    if (slot.getSlotType() != EntityEquipmentSlot.Type.ARMOR) {
      return null;
    }

    return SINGLETONS.computeIfAbsent(slot, ModelDragonstoneChainmailArmor::new);
  }
}